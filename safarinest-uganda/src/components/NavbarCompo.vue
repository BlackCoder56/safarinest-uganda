...
/* Navbar Styling */
.navbar {
  background-color: #42b983; /* Primary green */
...
.navbar-collapse.open {
  ...
  width: 100vw;
  height: 100vh;
  background-color: #42b983; /* Full-screen background */
  display: flex;
...
.close-icon {
  display: block;
  font-size: 24px;
  color: #F5F5F5; /* Same color as other text */
}
...
/* Style for the "X" close icon when menu is open */
.close-menu {
  position: absolute;
  top: 20px;
  right: 30px;
